...
function smtcwordpress_scripts() {
...
add_action( 'wp_enqueue_scripts', 'smtcwordpress_scripts' );

// Add Google Fonts
function smtcwordpress_google_fonts() {
				wp_register_style('OpenSans', 'http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800');
				wp_enqueue_style( 'OpenSans');
		}

		add_action('wp_print_styles', 'smtcwordpress_google_fonts');
